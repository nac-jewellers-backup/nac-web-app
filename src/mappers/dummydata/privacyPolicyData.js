...
export const privacyData = [
  ...
  {
    title: "Compliance with Law and Fraud Protection",
    para: [
      ...
      "(3) to other companies and organizations for credit fraud protection and risk reduction;",
  ...
  {
    title: "Suggestion and feedbacks",
    para: [
  ...
  },
  {
    ...
    para: [
      ...
      <div style={{ marginTop: "25px", marginBottom: "25px" }}>
        Data Collection Devices, such as Cookies and Web Beacons. In some
        instances, NAC Jewellers may collect data through cookies, web logs, web
        beacons (also known as pixel gifs or action tags) and other monitoring
        technologies to enhance your browsing and shopping experience on our
        website. (Cookies) are small pieces of information that are stored by
        your browser on your computer's hard drive to collect information about
        your activities on our website. Web beacons are small strings of code
        placed on a web page or within an email for the purpose of transferring
        information.
      </div>,
      ...
      <div style={{ marginTop: "25px", marginBottom: "25px" }}>
        ...
        you to review the privacy policies posted on these (and all) Websites.
        Accessing and Updating Your Information If the personally identifiable
        information NAC Jewellers has gathered from you changes or you would
        like to access, correct, or delete such information, we will gladly
        provide you access to, correct, or delete (to the extent allowed by law)
        any personal information we have collected about you. To request access
        to, a correction to, or deletion of your personal information, please
        send an e-mail to mail@nacjewellers.com or contact our customer care
        executives at +91 44 4399 6666
      </div>,
    ],
  },
  {
    title: "IP Address",
    para: [
      "We want to communicate with you only if you want to continue to hear from us. To opt out of receiving email promotions you have to check the subscribe News letter check box on user registrant and to unsubscribe click the check box and UN tick the selection.",
      "Write to Customer Service at NACJewellers Private Limited 58 North Mada Street, Chennai-600004 (a postal request). To opt out of telephone promotions, you can tell us when we call you or you can send us a postal request. To opt out of postal mail promotions, please send us a postal request.",
