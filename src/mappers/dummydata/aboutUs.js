      ...
      accordian: [
        ...
        },
        {
          ...
          norDots: [
            ...
            {
              para:
                "Valid for the contiguous 29 States, Puducherry and Delhi only! *T&C apply We also cater order to Manipur, Sikkim, Tripura on demand ;Kindly contact our customer care for further details +914443996666",
            },
          ],
        },
        {
        ...
        },
        {
          ...
          dots: [
            ...
            },
            {
              ...
              para:
                "If you choose to participate in a special event (for example, a promotion, contest, or sweepstakes), NAC Jewellers may share your personal information with those organizations participating in the applicable event. Unless we tell you otherwise in connection with a special event, these third parties do not use your information for any other purpose other than to manage the event. We may authorize trusted partners to send you information about products and services that may be of interest to you.",
            },
            {
      ...
      accordian: [
        {
          ...
          deliver: [
            {
              faqSubtitle:
                "What’s the guarantee that my product will reach safely?",
              faqPara:
          ...
          data: [
            {
              ...
              para:
                "Call our customer service executive at 044-4399 6666 or care@nacjewellers.com and you will be given a Return Authorization Code.",
            },
            {
              title: "Pack your product",
              para:
                "Pack your product securely in the same packaging that you had received the order along with the invoice and certificate that was delivered with the product. If the certificate is not returned, you may be liable for the cost of re-certification.",
            },
            {
            ...
            },
            {
              ...
              para:
                "Customized Jewellery which includes personalized/engraved products /ordered in line with specific instructions from Customer is not eligible for return/money back. Gold Coins are eligible for money back only at our stores.",
            },
          ],
