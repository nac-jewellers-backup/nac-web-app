                    ...
                    <Box className={classes.about}>
                        <div className={classes.parentPadding}>
                            <div className={classes.parentWidth} >
                                {birthStoneArr?.map((e) => {
                                    return (
                                        <div className={classes.parentRelative} >
                                            <div className={classes.parentCirlce}>
                                                <Box className={classes.heightItem}>
                                                    <img src={styloriLogo} className={classes.logo}></img>
                                                    <Typography><img className={classes.birthLogo} src={logo}></img></Typography>
                                            ...
                                            <div className={classes.Child7Cirlce}>
                                                <div className={classes.relativeCircle}>
                                                    ...
                                                    <div style={{ textAlign: "center" }}>{e?.birthStoneDetails?.colour}</div>
                                                    <img src={e?.birthStoneImg}></img>
                                                </div>
                                            </div>
