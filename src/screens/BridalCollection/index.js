          ...
          <Box display="flex" justifyContent="center">
            <Box>
              ...
              <Typography className={classes.bodys1}>
                We take pride i the fact that we have adorned scores of bridesiand
                have been a part of their journey through love and life. Our
                exclusive bridal collection i &s extravagant as it is lovely and
                will make the bride feel special and unique just as she really is.
                Our range of Digmond, Gold and Platinum jewels have special bridal
                collections for the young bride to choose from. We also have a
                special section of Azva jewels designed specifically for the.
              </Typography>
              <br />
              <br />
          ...
          <Grid container className={classes.about}>
            ...
            <Grid item xs={12} md={7} lg={7} className={classes.content2}>
              ...
              <Typography className={classes.sub}>
                Our bridal session is a premium service offered to
                <br />
                clients who can book in advance. Select your bridal
                <br />
                ﬁnery at peace and enjoy our personal shopping
                <br />
                experience to your fullest satisfaction. Call
                <br />
                +914443996666 to book a session today!
                <br />
              </Typography>
              <br />
              <center>
