                        ...
                        <Grid container spacing={2} >
                            <Grid container item xs={9}>
                                <Grid container xs={12} spacing={2}>
                                    ...
                                    <Grid item xs={8}>
                                        <img height="100%" width="100%" loading="lazy" alt='...' src='https://assets-cdn.stylori.com/552x276/images/homepage/Stylori-ring-tile.jpg' alt="" />
                                    </Grid>
                                    <Grid item xs={4}>
                                        <img height="100%" width="100%" loading="lazy" alt='...' src='https://assets-cdn.stylori.com/276x276/images/homepage/276X276 PIXELS MANGO COLLECTIONS TILE-01 (1).jpg' alt="" />
                                    </Grid>
                                </Grid>
                                <Grid container xs={12} spacing={2} style={{ marginTop: "6px" }}>

                                    <Grid item xs={4}>
                                        <img height="100%" width="100%" loading="lazy" alt='...' src='https://assets-cdn.stylori.com/276x276/images/homepage/-11.jpg' alt="" />
                                    </Grid>
                                    <Grid item xs={8}>
                                        <img height="100%" width="100%" loading="lazy" alt='...' src='https://assets-cdn.stylori.com/552x276/images/homepage/Stylori_ Daisy Days.jpg' alt="" />
                                    </Grid>
                                </Grid>
                            </Grid>
                            <Grid item xs={3} spacing={2} style={{ height: "650px" }}>
                                <img height="100%" width="100%" loading="lazy" alt='...' src='https://assets-cdn.stylori.com/276x567/images/homepage/blush 3.jpg' alt="" /></Grid>
                        </Grid>
                    </Container>
                </div>
                {/* <Grid container spacing={2} >
