          ...
          <div className="header-appbar-sticky" id="headerDiv">
            <AppBar className="header-appbar" id="topNav">
              <Grid container spacing={12}>
                ...
                <Grid item xs={5}>
                  <div
                    className={`head-icons ${classes.colorMain}`}
                    ...
                    Object.keys(Jewellery[selected]).map((row2) => (
                      <>
                        ...
                        >
                          ...
                          <ListItemText
                            onClick={() =>
                              this.selectItem1(Jewellery[selected][row2].name)
                            }
                          >
                            <Typography
                              className="Jew-mbl-head-list"
                              variant=""
                            >
