      ...
      <Grid item className={classes.widthFull}>
        ...
        <Grid container>
          <Grid item xs={12} sm={12} md={12} lg={4} xl={4}>
            ...
            <Grid item xs={12} sm={12} md={10} lg={10} xl={10}>
              ...
              <label className="errtext">
                {" "}
                {values.errorName && values.errorName}
              </label>
              <Input
                margin="normal"
                variant="outlined"
              ...
              <label className="errtext">
                {" "}
                {values.emailError && values.emailError}
              </label>
              <Input
                margin="normal"
                variant="outlined"
              ...
              <label className="errtext">
                {" "}
                {values.phoneError && values.phoneError}
              </label>
              <Input
                variant="outlined"
                type="text"
                ...
                error={
                  values.errorMessage && values.errorMessage ? true : false
                }
              />
              <label className="errtext">
                {" "}
          ...
          <Grid
            ...
            lg={4}
            xl={4}
            className={classes.midconatiner}
          >
            <Grid item>
        ...
        <Grid container>
          <Grid className={classes.dottedvalue}></Grid>
          <p class={classes.smallSizeTypoblue}>
            Chat and Email support is available Monday through Saturday 10am to
            7pm IST and we make a serious effort to respond in less than an
            hour. We do offer phone support, but if you really want to get us on
            the phone on different time zones, just submit the form and we'll
            schedule a call.
          </p>
        </Grid>
      </Grid>
