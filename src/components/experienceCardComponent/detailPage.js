    ...
    fetch(`${API_URL}/graphql`, {
        ...
        variables: {
          ...
          patch: {
            ...
            areMoreMembersJoining:
              values?.are_more_members_joining === "yes" ? true : false,
      ...
      .then((data) => {
        ...
        if (data?.data?.updateAppointmentById?.appointment?.id) {
          emailTrigger(data?.data?.updateAppointmentById?.appointment?.id);
        }
      });
  };
  ...
  return (
    <>
      {!finish ? (
          ...
          >
            <Card className={classes.Cardview}>
              <CardHeader
                ...
                subheader="and our Helpdesk will contact you for assistance"
                          ...
                          <Grid item xs={6}>
                            ...
                            >
                              {select?.timeSlotes?.length > 0 ? (
                                ...
                                <MenuItem
                                  style={{ color: "#7f8082", fontSize: "14px" }}
                                >
                                  {"No Slot available"}
                                </MenuItem>
                              )}
                    ...
                    <>
                            ...
                            {select.metaltype.map((val, index) => {
                              return (
                                <MenuItem key={index} value={val?.name}>
                                  <Checkbox
                                    checked={props?.values?.metalType?.some(
                                      (x) => x === val.name
                                    )}
                                  />
                                  <ListItemText
                      ...
                      >
                        <Grid item xs={6}>
                          ...
                          <Typography className={classes.normalfonts2_sub}>
                            {"(select upto 3 products)"}
                          </Typography>
                        </Grid>
                        <Grid item xs={6}>
                          <Select
                          ...
                          >
                            {select.productcategory.map((val, index) => (
                              <MenuItem key={index} value={val?.name}>
                                <Checkbox
                                  checked={props?.values?.productCategory?.some(
                                    (x) => x === val.name
                                  )}
                                />
                                <ListItemText
                          ...
                          <label className="errtext">
                            {" "}
                            {props.values.error.productCategory &&
                              props.values.error.productCategory}
                          </label>
                        </Grid>
                      </Grid>
                      ...
                      >
                        ...
                        <Grid item xs={6}>
                          ...
                          <label className="errtext">
                            {" "}
                            {props.values.error.specialRequests &&
                              props.values.error.specialRequests}
                          </label>
                        </Grid>
                      </Grid>
                      ...
                      >
                        ...
                        >
                          <FormControl component="fieldset">
                            <RadioGroup
                              aria-label="quiz"
                              value={props?.values?.isItRequired}
                              onChange={(e) =>
                                props.handleChange(
                                  "isItRequired",
                                  e.target.value
                          ...
                          <label className="errtext">
                            {" "}
                            {props.values.error.isItRequired &&
                              props.values.error.isItRequired}
                          </label>
                        </Grid>
                      </Grid>
                      ...
                      >
                        <Grid item xs={8}>
                          <h5 className={`title ${classes.normalfonts2}`}>
                            Will more members will be joining from other
                            locations :
                          </h5>
                        </Grid>
                        <Grid
                        ...
                        >
                          <FormControl component="fieldset">
                            <RadioGroup
                              aria-label="quiz"
                              value={props?.values?.are_more_members_joining}
                              onChange={(e) =>
                                props.handleChange(
                          ...
                          <label className="errtext">
                            {" "}
                            {props.values.error.are_more_members_joining &&
                              props.values.error.are_more_members_joining}
                          </label>
                        </Grid>
                      </Grid>
        ...
        <FinishCard back={props.back} type={props.type} finalContent={props.finalContent} finalImage={props.finalImage} />
      )}
    </>
  );
}
