    ...
    return (
        ...
        >
            ...
            <Hidden only={['lg', 'xl', 'md']} >
                ...
                <Grid container className={classes.colorMain} item xs={12} sm={12} style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', color: '#808080', fontSize: '11px', padding: "8px 0px" }}>
                    ...
                    </img>  ©  NAC Jewellers Pvt.Ltd. All rights reserved.
                    </Grid>
            </Hidden>

            <Hidden smDown>
                <Grid container style={{ display: 'flex', justifyContent: 'center', padding: "10px 15px" }} >
                    <Grid container className={classes.colorMain}>
                        <Grid item className={"imageClass"}>
                            < img src={"https://assets.stylori.com/images/static/footer.png"} style={{ width: "100%", height: "auto" }} />
                        </Grid>
