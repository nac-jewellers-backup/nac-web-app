...
import { TempleData, TempleWorkData } from "screens/templeWork/templeWorkData";
  ...
  const getComponents = (val) => {
    switch(val.type){
        case "ImageWithDescription": {
           return <ImageWithDescription custom={val.data.length === 5 ? true : false} data={val.data} />
        }
        case "MultipleSimilarImages":{
          return <MultipleSimilarImages data={val.data} header={val.header} subHeader={val.subHeader} invert={val.invert} />
        }
        case "TwoGridImages":{
                      ...
                      {e?.temples?.map((txt, index) => {
                        return (
                          <>
                            ...
                            >
                              <Typography className={classes.templeTxt}>
                                {txt?.name}
                              </Typography>
                              <Typography className={classes.weighTxt}>
                                {txt?.spec}
                                  ...
                                  return (
                                    ...
                                    >
                                      <>
                                        ...
                                        <Box className={classes.txtBox}>
                                          <Typography
                                            className={classes.TempleName}
                                          >
                                            {img?.text}
                                          </Typography>
                                          <Typography
                                            className={classes.weighTxt}
                                          >
                                            {img?.weigh}
                                          </Typography>
                                        </Box>
                  ...
                  return (
                    <>
                      <Grid item xs={12} className={classes.GridBox}>
                        <Box>
                          <Typography className={classes.TempleHead}>
                            {e?.txt}
                          </Typography>
                        </Box>
                        <Box>
