...
class Allorders extends React.Component {
  ...
  calculatetotal = (arr) => {
    var a;
    var dis_price;
    a = arr.shoppingCartByCartId.shoppingCartItemsByShoppingCartId.nodes
      .map((cart) => {
                    ...
                    <ExpansionPanelSummary expandIcon={<ExpandMoreIcon className="arrow-chek" />} className="ckcut-main-body">
                      <Typography className="text-chck">
                        ...
                        <div style={{ float: "right" }}>
                          <Button className="bton_submit">SUBMITTED</Button>{" "}
                        </div>
                      </Typography>
                    </ExpansionPanelSummary>
                    <ExpansionPanelDetails>
                      <div className="address_details">
                        ...
                        <div style={{ width: "100%", marginBottom: "10px" }}>
                          <Grid container spacing={12} lg={12} style={{ textAlign: "center" }}>
                            <Grid item lg={6} className="order_addres">
                              ...
                              <br />
                              <div>
                                <b>Order Date </b> : {moment(val.createdAt).format("MMM Do YYYY")}
                              </div>
                              <br />
                              <div>
                                {" "}
                        ...
                        <div style={{ float: "right", fontSize: "18px" }}>
                          Grand Total&nbsp;<span style={{ color: "#ed1165", fontSize: "18px" }}>{this.calculatetotal(val)}</span>
                        </div>
                            ...
                            <Grid container spacing={12} lg={12}>
                              ...
                              <Grid item lg={4}>
                                <Grid container spacing={12} lg={12} style={{ lineHeight: "20px" }}>
                                  ...
                                  <Grid item lg={6}>
                                    ...
                                    cart.transSkuListByProductSku.productListByProductId.productDiamondsByProductSku.nodes &&
                                    cart.transSkuListByProductSku.productListByProductId.productDiamondsByProductSku &&
                                    cart.transSkuListByProductSku.productListByProductId.productDiamondsByProductSku.nodes
                                      .length > 0 ? (
                                  ...
                                  <Grid item lg={6}>
                                    ...
                                    <Typography className="subhesder">
                                      {cart.transSkuListByProductSku &&
                                        ...
                                        cart.transSkuListByProductSku.productListByProductId.productDiamondsByProductSku
                                          .nodes[0] &&
                                        cart.transSkuListByProductSku.productListByProductId.productDiamondsByProductSku.nodes[0]
                                          .stoneWeight +
                                          " " +
                                          "CT"}
                                    </Typography>
                                    <Typography className="subhesder">{cart.transSkuListByProductSku.generatedSku}</Typography>
                                  </Grid>
                                </Grid>
                              </Grid>
                              ...
                              <Grid style={{ padding: "30px" }} className="rups" item lg={2}>
                                {Math.round(cart.transSkuListByProductSku.markupPrice) < Math.round(cart.price) ? (
                                  <del style={{ color: "rgba(0, 0, 0, 0.54)", fontSize: "18px" }}>
                                    {Intl.NumberFormat("en-IN", {
                                      style: "currency",
                                      currency: "INR",
                                      minimumFractionDigits: 0,
                                    }).format(Math.round(cart.transSkuListByProductSku.markupPrice))}
                                  </del>
                                ) : (
                                  ""
                                )}
                                ...
                                {Intl.NumberFormat("en-IN", {
                                  ...
                                  currency: "INR",
                                  minimumFractionDigits: 0,
                                }).format(Math.round(cart.transSkuListByProductSku.discountPrice))}
                              </Grid>
                            </Grid>
                          </>
                        ))}
                        ...
                        <div style={{ float: "right", fontSize: "15px" }}>
                          ...
                          <div style={{ float: "right", fontSize: "18px" }}>
                            Grand Total&nbsp;
                            <span style={{ color: "#ed1165", fontSize: "18px" }}>{this.calculatetotal(val)}</span>
                          </div>
                        </div>
                      </div>
                      {/* {val.paymentStatus} */}
