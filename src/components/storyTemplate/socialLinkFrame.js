    ...
    <Grid container>
      <Grid container>
        <Grid item md={12} style={{ marginTop: "10px" }}>
          <Typography style={{ color: "#2F348B" }} component="h4">
            Instagram
          </Typography>
        </Grid>
        <Grid
      ...
      <Grid container>
        ...
        <Grid
          item
          style={{ width: "343px", border: "1px solid #ccc", marginTop: "5px" }}
        >
          <StyloriNews
            fadeImages={storyData.NewsFeeds.carousel.data}
            dataCarousel={storyData.NewsFeeds.carousel.setting}
          />
        </Grid>
      </Grid>
      <Grid container>
