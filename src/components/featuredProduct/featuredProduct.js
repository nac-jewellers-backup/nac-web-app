...
export default function FeaturedProduct(props) {
    ...
    return (
        ...
        <Slideshow dataCarousel={YoungOnes.setting} sliderRef={slider}>
            ...
            {YoungOnes && YoungOnes.carousel && YoungOnes.carousel.map(val =>
               <>
                <Grid container >
                ...
                <Button  type="button" className={classes.button} style={{ fontSize: "13px" }}> 
                <img style={{width: "25px",paddingRight:"10px"}} src="data:image/png;base64," /> 
                {val.buttonName}</Button></a>
            </Grid>
