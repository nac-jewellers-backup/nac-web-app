...
function HeaderHoverMenuItem(props) {
  ...
  const imageForEarRings= [{img:"https://imgmediagumlet.lbb.in/media/2019/08/5d4e38a8de22e35fd497babb_1565407400197.jpg?fm=webp&w=750&h=500&dpr=1"}]
  const imageForRings= [{img:"https://adn-static1.nykaa.com/nykdesignstudio-images/tr:w-410,/pub/media/catalog/product/d/c/dc-rng-10052_1.jpg?rnd=20200526195200"}]
 ...
 const collectionsData = [
   {title:"Traditional Setting",
    image:"https://storage.googleapis.com/media.nacjewellers.com/resources/dist/jewellery/gold/muhurtham/necklace/2-cy7845.png"
   },
   {title:"Young Ones",
    image:"https://storage.googleapis.com/media.nacjewellers.com/resources/dist/jewellery/collection/youngones/ring/bc3776-f.png"
   },
   {title:"Mens",
    image:"https://storage.googleapis.com/media.nacjewellers.com/resources/dist/jewellery/diamond/close-setting/gents-ring/521682.png"
   },
   {title:"Mayura",
    image:"https://storage.googleapis.com/media.nacjewellers.com/resources/dist/jewellery/diamond/mayura/earring/bl6413-f.png"
   },
   {title:"Fabula",
    image:"https://storage.googleapis.com/media.nacjewellers.com/resources/dist/jewellery/diamond/fabula/earring/bj0928-2.png"
   },
   {title:"Muhurtham",
    image:"https://storage.googleapis.com/media.nacjewellers.com/resources/dist/jewellery/gold/muhurtham/necklace/2-db3518-f.png"
   },
   {title:"Uncut",
    image:"https://storage.googleapis.com/media.nacjewellers.com/resources/dist/jewellery/collection/uncut/necklace/9-302468.png"
   },
   {title:"Jadau",
    image:""
   },
   {title:"Nagas",
    image:"https://storage.googleapis.com/media.nacjewellers.com/resources/dist/jewellery/gold/nagas/earrings/bn6921.png"
   },
   {title:"Rewind",
    image:"https://storage.googleapis.com/media.nacjewellers.com/resources/dist/jewellery/gold/earrings/888578+888581-royal-ruby-antique-stud-earring.png"
   },
   {title:"Strings",
    image:"https://storage.googleapis.com/media.nacjewellers.com/resources/dist/jewellery/gold/kundan/necklace/ay8439-2.png"
   },
   {title:"Forevermark",
    image:"https://storage.googleapis.com/media.nacjewellers.com/resources/dist/jewellery/diamond/earrings/134-bw2850.png"
   },
 ]
...
const solitaireData = [
  {
    title:"Rings",
    image:"https://storage.googleapis.com/media.nacjewellers.com/resources/dist/jewellery/diamond/rings/135-ac4820.png"
  },
  {
    title:"Earrings",
    image:"https://assets.stylori.com/images/Menu/Jewellery/Earrings/Studs+Earrings+Stylori-01.png"
  },
  {
    title:"Necklaces",
    image:"https://storage.googleapis.com/media.nacjewellers.com/resources/dist/jewellery/gold/muhurtham/necklace/2-cy7845.png"
  },
  {
    ...
    image:"https://storage.googleapis.com/media.nacjewellers.com/resources/dist/jewellery/gold/5k-to-35k/bangle/3-bs6486.png"
  },
  {
    title:"Pendants",
    image:"https://storage.googleapis.com/media.nacjewellers.com/resources/dist/jewellery/diamond/close-setting/bangle/bl1017.png"
  },
  {
    title:"Men's rings",
    image:"https://storage.googleapis.com/media.nacjewellers.com/resources/dist/jewellery/diamond/close-setting/gents-ring/521682.png"
  ...
  const ForCollections = () => {
    ...
    >
      <Grid container item xs={12}>
        <Grid item xs={8} className={classes.gridmultiplesection} style={{paddingTop:"20px"}}>
          <Grid container item xs={12}>
                  ...
                  <Grid
                   ...
                   >
                    ...
                    {val.content.map((item,i)=>
                      <Typography style={{ margin: "auto", textAlign: "center",color:"#000",paddingTop:"14px"}}
                          className={classes.listedItemsvalue}>
                            {item.itm}
                        </Typography>
                    )} 
  ...
  const SavingSchemee = () => {
    ...
    >
        <Grid item container xs={12} className={classes.gridmultiplesection}> 
            ...
            <Typography className={classes.listedItemstitle} style={{borderBottom:"none"}}>
              {val.title.toUpperCase()}
            </Typography>
            </Grid>
                  ...
                  <Grid item xs={6}>
                    ...
                    >
                      ...
                      >
                        {val.img && (
                          <img
                            style={{ width: "50%", margin: "auto", marginBottom: "15px" }}
                            src={val.img}
                          />
                        )}
                      </Grid>
            ...
            {solitaireData2.map((val,i)=>
              <Grid item xs={12}>
                ...
                {val.contents.map((x,i)=>
                  <Typography className={classes.listedItemsvalue} style={{color:"#000", paddingBottom:"15px",textAlign:"center"}}>
                    {x.sub}
                  </Typography>
                )} 
                </Grid>
      ...
      <Grid item xs={1}></Grid>
        <Grid item xs={2} className={classes.gridmultiplesection} >
           {solitaireData3.map((val,i)=>
             <Grid container item xs={12} style={{borderBottom: "1px solid #33346d"}}>
                 <Grid item xs={12}>
                   <Typography className={classes.listedItemstitle} style={{textAlign:"center"}}>
                       {val.title.toUpperCase()}
                   </Typography>
           ...
           <div>
            ...
            {solitaireData4.map((val,i)=>
              <Typography  className={classes.listedItemstitle} style={{borderBottom:"none", marginBottom:"2px",marginTop:"7px",textAlign:"center"}}>
                  {val.title.toUpperCase()}
              </Typography>
             )}
           </div>
