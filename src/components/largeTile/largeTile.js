    ...
    return (
        ...
        <Grid item xs={12} lg={6} sm={6} md={6} className={classes.paddings} >
            {props.tag === "normal" ?
                <>
                    <Grid>
                        ...
                        <Slideshow style={{ width: "100%" }} dataCarousel={props.setting1}
                            sliderRef={slider}    >
                        ...
                        state.showLess === true ?
                            ...
                            <>
                                ...
                                <Grid>
                                    ...
                                    <Slideshow style={{ width: "100%" }} dataCarousel={props.setting1}
                                        sliderRef={slider}    >
                                        <img onClick={handleReadMore} style={{ width: "100%", height: "100%" }} src={props.img} />
                                    </Slideshow>
                            ...
                            <>
                                ...
                                <Grid>
                                    <Grid container>
                                        ...
                                        ></Grid>
                                        <Grid item onClick={next} className={classes.nextButtons}></Grid>
                                    </Grid>
                                    <>
                                    <Slideshow style={{ width: "100%" }} dataCarousel={props.setting2}
                                        sliderRef={slider}    >
                                        {props.imgPics.map((val, index) => (
                                            <Grid container key={index}>
                                                <img onClick={handleReadMore} style={{ width: "100%", height: "100%" }} src={val.img} />
                                            </Grid>
                                        ))}
                            ...
                            <>
                                <Grid>
                                    ...
                                    <Slideshow style={{ width: "100%" }} dataCarousel={props.setting1}
                                        sliderRef={slider}    >
                                        <img onClick={handleReadMore} style={{ width: "100%", height: "100%" }} src={props.img} />
                                        <>     <img onClick={handleReadMore} className={classes.youtubeImg} src={props.youtubeImg} /> </>
            ...
            {window.innerWidth>0 && window.innerWidth<=600&&
                                <Grid style={{display:"block"}}>
                                    ...
                                    <iframe width="100%" height="201" src={props.url} frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"></iframe>
       ...
       {window.innerWidth>601 && window.innerWidth<=960&&
                                <Grid style={{display:"block"}}>
                                    ...
                                    <iframe width="100%" height="214" src={props.url} frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"></iframe>
       ...
       {window.innerWidth>961 && window.innerWidth<=1280&&
                                <Grid style={{display:"block"}}>
                                    ...
                                    <iframe width="100%" height="273" src={props.url} frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"></iframe>
       ...
       {window.innerWidth>1281 && window.innerWidth<=1920&&
                                <Grid item  style={{display:"block"}} contained>
                                   ...
                                   <iframe width="100%"  height="372" src={props.url} frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"></iframe>
       ...
       {window.innerWidth>1921 && window.innerWidth>1922&&
                                <Grid style={{display:"block"}} >
                                    ...
                                    <iframe width="100%" height="400" src={props.url} frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"></iframe>
