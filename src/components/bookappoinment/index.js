import { Box, Button, Container, FormControl, Grid, IconButton, InputLabel, MenuItem, Select, Typography } from "@material-ui/core";
                        ...
                        <Grid item xs={12} sm={12} md={12} xl={12}>
                            ...
                            <Grid container spacing={2}>
                                <Grid item xs={12} md={5}>
                                    <img src="https://s3.ap-southeast-1.amazonaws.com/media.nacjewellers.com/resources/bridalcollection/bannercard.png" height="100%" width="100%" />
                                </Grid>
                                <Grid item xs={12} md={7}>
                                    <Typography style={{ color: "gray", fontFamily: "24px" }}>Brides & their families</Typography>
                                    <Grid container spacing={2}>
                                        <Grid item xs={4}>

                                            <FormControl fullWidth>
                                                <InputLabel color="secondary" id="demo-simple-select-label">Month</InputLabel>
                                                <Select
                                        ...
                                        <Grid item xs={2}>
                                            <FormControl fullWidth>
                                                <InputLabel color="secondary" id="demo-simple-select-label">Day</InputLabel>
                                                <Select
                                                    labelId="demo-simple-select-label"
                                                    id="demo-simple-select"
                                                    color="secondary"
                                        ...
                                        <Grid item xs={4}>  <FormControl fullWidth>
                                            <InputLabel color="secondary" id="demo-simple-select-label">Year</InputLabel>
                                            <Select
                                                labelId="demo-simple-select-label"
                                                id="demo-simple-select"
