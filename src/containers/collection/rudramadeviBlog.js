        ...
        <Grid container xs={12}>
            ...
            <>
                <Grid item xs={12}>
                    <Grid
                        ...
                        xs={12} lg={12}
                    ></Grid>
                    <Grid item xs={12} lg={12} onClick={next} className={classes.nextButton}></Grid>
                </Grid>
                <Slideshow style={{ width: "100%" }} dataCarousel={Rudramadevi.carouselTop.setting}
                    sliderRef={slider}    >
            ...
            {/* <Grid item xs={12} className={classes.anchorMain}>
                ...
                <Grid container className={classes.text} xs={12}>
                    <Typography style={{ width: "100%", fontSize: "28px", }}>The Original Drawings from the NAC Team</Typography>
                    <Typography style={{ width: "100%", color: "#5d5d5d", fontSize: "14px" }}>Staff Writer, May 6 2016, 14:23</Typography>
                </Grid>
                <Grid container className={classes.container} xs={10} lg={6}>
                    <Typography dangerouslySetInnerHTML={{ __html: Rudramadevi.para }}></Typography>
                </Grid>
            </Grid>
